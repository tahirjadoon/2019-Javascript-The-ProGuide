...
//Task6: create an object so that we can resuse the text values
let mathOperations = {
  add: "ADD",
  addOperator: "+",
  subtract: "SUBTRACT",
...
//Task 6: Create a new function to calculate which will use conditional if else statements
...
//Task6: remove the code and call the new function with the proper values passed in
function add() {
  calculateResult(mathOperations.add, mathOperations.addOperator);
}

function subtract() {
  calculateResult(mathOperations.subtract, mathOperations.subtractOperator);
}

function multiply() {
  calculateResult(mathOperations.multiply, mathOperations.multiplyOperator);
}

function divide() {
  calculateResult(mathOperations.divide, mathOperations.divideOperator);
}
